             ...
             <div className="animate-in fade-in slide-in-from-right-4 duration-500">
                <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] p-8 md:p-12 border border-zinc-200 dark:border-zinc-800 shadow-2xl">
                   ...
                   {currentOrder.status === 'cancelled' ? (
                                            <div className="p-10 bg-rose-50 dark:bg-rose-950/30 rounded-3xl text-center border-2 border-dashed border-rose-200 dark:border-rose-900/40">
                         <h3 className="text-2xl font-black text-rose-600 dark:text-rose-500">Pesanan Dibatalkan</h3>
                         <p className="text-zinc-500 dark:text-zinc-400 italic mt-2">&quot;{currentOrder.cancelReason || 'Kebijakan Rumah Sakit'}&quot;</p>
                      </div>
