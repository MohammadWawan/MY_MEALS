...
const file_path = 'd:\\\\MY MEALS\\\\src\\\\app\\\\admin\\\\menu\\\\page.tsx';
...
const handle_edit_new = `      let parsedNutrition = [];
      try {
...
let order_content = fs.readFileSync(order_file, 'utf8');
...
// Nutrition render replacement
const nutrition_render = `
...
fs.writeFileSync(order_file, order_content, 'utf8');
