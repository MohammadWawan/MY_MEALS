...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] p-6 md:p-10 bg-zinc-50 dark:bg-zinc-950 flex justify-center">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-3xl shadow-2xl w-full max-w-xl relative">
        <button 
          onClick={() => router.push("/profile/settings")}
          className="absolute top-8 right-8 text-zinc-400 hover:text-indigo-500 transition-colors p-2"
